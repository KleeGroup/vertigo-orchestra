...
final class ReschedulerTimerTask extends TimerTask {
	private final SimpleSchedulerPlugin simpleSchedulerPlugin;
	 ...
	 */
	ReschedulerTimerTask(final SimpleSchedulerPlugin simpleSchedulerPlugin, final ProcessDefinition processDefinition, final Date nextExecutionDate) {
