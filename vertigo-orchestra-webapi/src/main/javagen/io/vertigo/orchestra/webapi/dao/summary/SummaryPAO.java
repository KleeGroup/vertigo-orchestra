...
public final class SummaryPAO implements StoreServices {
	...
	*/
	 ...
	 * @param dateMax java.util.Date 
	 * @param name String 
	 * @return io.vertigo.orchestra.webapi.domain.summary.OExecutionSummary dtExecutionSummary
	*/
	public io.vertigo.orchestra.webapi.domain.summary.OExecutionSummary getExecutionSummaryByDateAndName(final java.util.Date dateMin, final java.util.Date dateMax, final String name) {
